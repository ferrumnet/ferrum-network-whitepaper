...
This leads us to the next wave in blockchain development, application-specific blockchains. These chains are being developed to solve a specific problem. From decentralized computing resources and storage to the financial settlement of assets between crypto and fiat worlds. Chains like Algorand are dedicated to financial settlement while chains like Cudos are dedicated to solving the decentralized cloud computing problem.
...
Our comprehensive approach includes essential core components that will ensure the success of Application-Specific Blockchains as well as General-Purpose Blockchains through standardized interoperability protocols.&#x20;
